...
public sealed partial class CollectSourcePane : UserControl
{
    ...
    public static readonly DependencyProperty StatusTextProperty = DependencyProperty.Register(
        nameof(StatusText), typeof(string), typeof(CollectSourcePane), new PropertyMetadata(string.Empty));
    ...
    public static readonly DependencyProperty ToggleOptionTextProperty = DependencyProperty.Register(
        nameof(ToggleOptionText), typeof(string), typeof(CollectSourcePane), new PropertyMetadata(string.Empty));
